...
\ref{tab:3.dataset} merangkum karakteristik keempat dataset yang
digunakan.
...
\begin{table}[H]
  ...
  \begin{tabular}{p{3.8cm} l l p{2.6cm} p{1.8cm}}
    ...
    E-SERAVD & Target & Indonesia & [\emph{lihat Santoso et al., 2026}] & [...] \\
    IndoWaveSentiment & Target & Indonesia & [\emph{lihat Nugroho et al., 2025}] & [...] \\
    \bottomrule
  \end{tabular}
  \end{adjustbox}
\end{table}
...
\noindent
Jumlah sampel dan kelas untuk RAVDESS dan CREMA-D di atas mengacu pada
dokumentasi resmi masing-masing korpus; angka untuk E-SERAVD dan
IndoWaveSentiment perlu disesuaikan dengan dokumentasi resmi dataset
tersebut sebagaimana dilaporkan oleh Santoso, Budianto and Dutono (2026)
dan Nugroho et al. (2025) sebelum dataset benar-benar diperoleh dan
diverifikasi.
