...
dan VRAM pada Subbab \ref{sec:3.9.2} dengan data riil.
...
perbedaan performa antarkondisi eksperimen.

\section{Analisis Hasil}
\label{sec:3.7}

Tahap ini menafsirkan hasil pengujian signifikansi statistik untuk
menjawab rumusan masalah penelitian, serta menyusun rekomendasi
strategi \emph{fine-tuning} yang paling sesuai untuk pengembangan SER
berbahasa Indonesia berdasarkan temuan yang diperoleh.
