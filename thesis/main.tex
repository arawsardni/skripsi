...
%
%  Cakupan proposal skripsi FILKOM = Bab 1–3 + Daftar Referensi saja
%  (Bab 4 dst. baru ditulis setelah proposal disetujui pembimbing).
% =====================================================================
...
% Calibri adalah font proprietary Microsoft dan tidak bisa di-embed langsung
% oleh XeLaTeX di lingkungan non-Windows. Carlito adalah pengganti
% metrik-kompatibel resmi untuk Calibri (dipakai LibreOffice sebagai
% substitusi Calibri), sehingga tata letak/line-break identik.
% Jika Calibri asli TERSEDIA di sistem Anda (mis. Windows + MS Office),
% cukup ganti "Carlito" menjadi "Calibri" pada baris \setmainfont di bawah.
\setmainfont{Carlito}
...
% sementara badan teks tetap Carlito — ini perilaku standar LaTeX dan tetap
...
\hypersetup{
  pdftitle={Analisis Pengaruh Strategi Fine-Tuning Dua Tahap terhadap Akurasi Pengenalan Emosi Ucapan Berbahasa Indonesia},
...
% ── Metadata dokumen ─────────────────────────────────────────────────
\title{Analisis Pengaruh Strategi Fine-Tuning Dua Tahap terhadap Akurasi
...
% CATATAN PENTING: keempat \include di bawah ini dinonaktifkan karena
% isinya khas SKRIPSI FINAL pasca-sidang, bukan tahap proposal:
%   - lembar_pengesahan : berisi "telah diuji dan dinyatakan lulus" +
%                          tanda tangan pembimbing pasca-ujian
%   - pernyataan_keaslian: pernyataan orisinalitas karya (baru relevan
%                          setelah naskah lengkap, bukan saat proposal)
%   - abstrak            : mensyaratkan "hasil utama" dan "kesimpulan",
%                          yang belum ada karena penelitian belum jalan
%   - kata_pengantar     : bernada "tesis ini dapat diselesaikan"
% Menurut Panduan Skripsi Filkom UB v3.0, proposal skripsi hanya
% mencakup Pendahuluan, Landasan Kepustakaan, Metodologi Penelitian,
% dan Daftar Referensi — tanpa keempat elemen di atas.
% Aktifkan kembali (hapus tanda %) saat naskah menjadi skripsi lengkap
% pasca-penelitian dan sidang.
\pagenumbering{roman}
\setcounter{page}{1}
...
% Bab 4 dst. (Perancangan, Implementasi, Pengujian, Penutup) baru ditulis
% setelah proposal ini disetujui pembimbing — aktifkan kembali baris di
% bawah pada tahap penulisan skripsi penuh.
